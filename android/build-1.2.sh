...
s=re.sub(r'versionName\s+"[^"]+"', 'versionName "1.2.6"',s,count=1)
...
cd ..
mkdir -p dist
cp android/app/build/outputs/apk/release/app-release-unsigned.apk dist/chores-1.2.6-unsigned.apk
cp android/app/build/outputs/bundle/release/app-release.aab dist/chores-1.2.6-unsigned.aab
